...
class LauncherScreen(Screen):
    ...
    BINDINGS = [
        ...
        Binding("g", "launch('btn-gcp')", "GCP Instances", priority=True),
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="launcher-box"):
            ...
            yield Button("[g] GCP Instances", id="btn-gcp", classes="launcher-btn")
            yield Button(
