...
### 260309-pi-zero-accurate
- Replaced box approximation of RaspberryPiZero2W with an exact parametric solid (65x30x1.5mm PCB, corner radii, precise M2.5 mounting holes, and component clearances).
- Passed `make validate` rendering the new geometry into CAD assemblies and simulation collision meshes.
