...
| `exp/260220-simple-hand` | Parallel-jaw picker on Cartesian rails can learn reach-grasp-lift with PPO + sensors-only MLPPolicy and touch feedback | In progress | - |
