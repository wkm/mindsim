...
def regen_rom_renders() -> None:
    ...
    from botcad.bracket import BracketSpec, servo_solid
    from botcad.bracket import coupler_solid_solid as coupler_solid
    from botcad.bracket import cradle_solid_solid as cradle_solid
